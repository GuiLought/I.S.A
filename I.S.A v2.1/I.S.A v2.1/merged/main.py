...
def inicializar_intro():
    ...
    frame_names = ["S1.png", "S2.png", "S3.png",
                   "S4.png", "S5.png", "S7.png"]
    intro_frames = []
    for nome in frame_names:
        try:
            sprite = carregar_imagem("personagens", nome)
            intro_frames.append(pygame.transform.scale(sprite, (220, 220)))
        except:
            continue
    if not intro_frames:
        try:
...
def desenhar_intro(mouse_pos):
    ...
    if intro_personagem_img and intro_personagem_rect:
        ...
        # Retângulo interativo — preenchido pelo sprite, borda animada
