...
class Enemy:
    ...
    def draw(self, surface, camera_x, camera_y):
        # Desenha um círculo em vez de imagem
        centro_x = self.rect.centerx - camera_x
        centro_y = self.rect.centery - camera_y
        raio = self.LARGURA // 2
        
        # Desenha o círculo principal
        pygame.draw.circle(surface, self.COR, (centro_x, centro_y), raio)
        # Desenha a borda
        pygame.draw.circle(surface, self.COR_BORDA, (centro_x, centro_y), raio, 3)
        # Desenha os olhos
        pygame.draw.circle(surface, (255, 255, 255), (centro_x - raio//3, centro_y - raio//3), raio//6)
        pygame.draw.circle(surface, (255, 255, 255), (centro_x + raio//3, centro_y - raio//3), raio//6)
